...
/* i'm lost author, so if you will find he, please contact me if i'm still alive */
public class JarUtils {
    ...
    private static boolean shouldLoadFromJar() {
        return (Gdx.app.getType() == Application.ApplicationType.Desktop || Gdx.app.getType() == Application.ApplicationType.HeadlessDesktop) && getJarFile() != null;
    }
